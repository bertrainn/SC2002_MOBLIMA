...
//        		 + "freed from his earthly tomb, ready to unleash his unique form of justice on "
//        		 + "the modern world.";
...
//        		 + "loving mother makes a death pact with a spirit, sacrificing herself to save "
...
//        		 + "widowed with her grown up son, Sam (Shane Pow) about to fly the roost, Auntie "
//        		 + "is left to contend with a whole new identity beyond her roles of daughter, "
//        		 + "wife, and mother. A solo trip to Korea becomes a wild adventure for Auntie, "
//        		 + "where she meets Kwon-Woo (Kang Hyung Suk), a young tour guide who can’t seem "
//        		 + "to get his life in order, and Jung Su (Jung Dong-Hwan), an elderly security "
...
//        		 + "learns to embrace her new independent life with renewed confidence and panache.";
...
//        		 + "quintuplets: Ichika, Nino, Miku, Yotsuba and Itsuki Nakano to a point where "
//        		 + "they can graduate and pursue their own dreams. At last, it is the final "
//        		 + "school festival and Futaro resolved to make this an occasion that they will "
